...
class IndividualsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post individuals_url, params: { individual: { hyper: @individual.hyper, linkd: @individual.linkd, photo: @individual.photo, player_id: @individual.player_id } }
    end
  ...
  test "should update individual" do
    patch individual_url(@individual), params: { individual: { hyper: @individual.hyper, linkd: @individual.linkd, photo: @individual.photo, player_id: @individual.player_id } }
